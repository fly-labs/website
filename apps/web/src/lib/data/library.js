...
export const books = [
  ...
  },
  {
    ...
    description: `How to find ideas worth building and kill the ones that aren't. The full system: ${SOURCE_COUNT} sources, 4 scoring frameworks, real market validation. Everything I learned building the Ideas Lab, distilled into one book.`,
    topic: 'Business',
    status: 'coming_soon',
    coverColor: 'accent',
    downloadUrl: null,
