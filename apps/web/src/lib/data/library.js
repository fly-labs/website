export const books = [
  ...
  },
  {
    ...
    description: 'The complete playbook for discovering, scoring, and validating business ideas. 5 sources, 3 frameworks, real validation from X and Reddit, competitive analysis.',
    topic: 'Business',
    status: 'coming_soon',
    coverColor: 'accent',
    downloadUrl: null,
