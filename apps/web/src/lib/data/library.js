export const books = [
  ...
  },
  {
    ...
    description: 'How to find ideas worth building and kill the ones that aren\'t. The full system: 9 sources, 4 scoring frameworks, real market validation. Everything I learned building the Idea Lab, distilled into one book.',
    topic: 'Business',
    status: 'coming_soon',
    coverColor: 'accent',
    downloadUrl: null,
