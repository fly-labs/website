...
const milestones = [
  ...
  },
  {
    ...
    description: 'New ideas come from Reddit, ProblemHunt, and the community. AI scores them. The best ones get built. The cycle continues.',
    link: { label: 'Browse the idea board', to: '/ideas' },
  },
];
