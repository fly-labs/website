                              ...
                              <div className="flex items-start justify-between gap-2 mb-1">
                                <div className="flex items-center gap-2 min-w-0">
                                  <h3 className="font-semibold text-foreground leading-snug group-hover:text-primary transition-colors">
                                    {idea.source === 'problemhunt' && idea.source_url ? (
                                      <a
            ...
            >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-center gap-3 pt-2 border-t border-border">
                  ...
                  {selectedIdea.source === 'problemhunt' && selectedIdea.source_url && (
                    <a
                      ...
                      onClick={() => trackEvent('outbound_click', { link_url: selectedIdea.source_url, link_label: 'ProblemHunt Detail', location: 'ideas_drawer' })}
                    >
