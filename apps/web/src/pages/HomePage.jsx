...
const pillars = [
  ...
  },
  {
    title: 'Idea Lab',
    icon: Users,
    description: 'Real problems from Reddit, ProblemHunt, Product Hunt, X, and the community. AI-scored, validated against real conversations on X and Reddit. Drop yours too.',
