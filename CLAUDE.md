...
│   │   │   └── ideas.js          # Idea categories, industries, statusConfig, sortOptions (9-way), sourceOptions (6 options), perPageOptions, frequencyOptions, formSteps
...
- **ideas.js:** categories (Tool/Template/Prompt/Article/Other), industries (30 domain verticals from ProblemHunt/Reddit + Other), statusConfig (open/building/shipped), sortOptions (9-way: hot/newest/oldest/top/hormozi/koe/okamoto/validation/verdict), sourceOptions (all/community/problemhunt/reddit/producthunt/x), perPageOptions (5/10/20/50), frequencyOptions (Daily/Weekly/Sometimes/Once), formSteps (3-step submit). Three-dimension filtering: Source x Type x Industry
