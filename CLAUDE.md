...
│   │   │   ├── prompts.js        # 89 prompts across 8 categories (featured flag for lead magnet)
...
│       ├── FlyBoardPage.jsx       # Public - FlyBoard collaborative whiteboard
...
- **prompts.js:** 89 prompts across 8 categories (Coding, Writing, Strategy, Marketing, SEO, Research, Workflows, Thinking). Each has: id, title, category, description, content, featured (optional - marks lead magnet for guest view), tools (optional - array of tool names for workflows)
