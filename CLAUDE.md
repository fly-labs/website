...
│   │       ├── IdeaCard.jsx      # Idea card (vote, verdict + FL score badges, competitor count, 8-source display, status logic)
...
│       ├── IdeaSubmissionPage.jsx # Idea Lab (URL state filters via useIdeaFilters hook, search, verdict tabs, active chips, 8-source pills, filter sheet, smart empty states)
