...
│   │       └── MusicPanel.jsx    # Slide-up player panel (track info, visualizer, controls, volume)
│   ├── contexts/
...
│   │   ├── MusicContext.jsx  # Audio engine (HTML5 Audio + Web Audio API visualizer, shuffle, volume, FlyBot bridge, MediaSession)
...
│   │   │   ├── tracks.js        # Music player track data (auto-generated by scripts/setup-music.mjs)
...
| `music_track_played` | MusicContext | `track_title`, `track_artist`, `source` (user/flybot) |
